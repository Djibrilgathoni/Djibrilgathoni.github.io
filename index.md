...
<section class="reveal">
  <h2 class="section-title">My Projects & Labs</h2>
  <p style="text-align: center; max-width: 700px; margin: 0 auto 30px; color: #aaa;">
...
<section class="reveal">
  <h2 class="section-title">Key Results & Impact</h2>
  <div class="results-grid">
    <div class="result-card">
      <div class="metric" data-target="99.9" data-suffix="%">0%</div>
      <p><strong>Network Uptime</strong><br>Maintained infrastructure for 200+ Active Directory accounts</p>
    </div>
    <div class="result-card">
      <div class="metric" data-target="92" data-suffix="%">0%</div>
      <p><strong>First-Contact Resolution</strong><br>Fast IT support to 50+ users during internship</p>
    </div>
    <div class="result-card">
      <div class="metric" data-target="50" data-suffix="+">0+</div>
      <p><strong>Vulnerabilities Identified</strong><br>Through personal security labs and scanning practice</p>
    </div>
    <div class="result-card">
      <div class="metric" data-target="10" data-suffix="+">0+</div>
      <p><strong>Hack The Box Machines</strong><br>Including Fawn via FTP enumeration + privilege escalation</p>
    </div>
    <div class="result-card">
      <div class="metric" data-target="100" data-suffix="+">0+</div>
      <p><strong>Endpoints Patched</strong><br>Reduced security risks across the network</p>
    </div>
  </div>
</section>
